...
<body>
    ...
    <div class= "account-find">
        ...
        <div class="tab-list">
            <ul>
                <li style = "margin-right: 20px;"><a href="${pageContext.request.contextPath}/app/user/find_id.jsp">아이디 찾기</a></li>
                <li class="active"><a href="${pageContext.request.contextPath}/app/user/find_password.jsp">비밀번호 찾기</a></li>
...
<script src="${pageContext.request.contextPath}/app/user/find_password.js"></script>
</html>