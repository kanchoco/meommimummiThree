...
public class postListFollwingController implements Execute {
	...
	public Result execute(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		followingDAO.selectFollowing(followerNumber).forEach(followingNumber->{
			System.out.println("followingNumber:"+followingNumber);
//			follower와 following 쿼리문으로 조회 기능이 동일하므로 재사용
			followingposts.addAll(postDAO.selectFollowerDefault(followingNumber.getFollowerNumber()));
